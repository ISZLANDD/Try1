...
async def on_ready():
    ...
    while True:
        ...
        activity = discord.Activity(type=discord.ActivityType.watching, name=f'ICE TOOLS AND JAD')
...
async def bronze(ctx):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    embed=discord.Embed(title="Free Bronze",color=10181046, description=f"**set .gg/zM2sSuG56e status, you will automatically get a rank Bronze**")
    await ctx.send(embed=embed)
...
async def on_member_update(before, after):
    ...
    if 'https://discord.gg/ice-tools' in str(before.activities):
      if 'https://discord.gg/ice-tools' in str(after.activities):
        pass
      else:
...
@bot.command()
async def clear(ctx):
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/968925494236033074/jw8XuZXQbk31FwOIBF1DJzq6NLv871WXky2_Io5mVYY8uBdeUkZHVq9owsJZlrSvK52k')
...
async def tfollow(ctx, arg):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/968925494236033074/jw8XuZXQbk31FwOIBF1DJzq6NLv871WXky2_Io5mVYY8uBdeUkZHVq9owsJZlrSvK52k')
    embed = DiscordEmbed(title='Twitch Follower V4', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}tfollow -> {arg}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel =json_object['bot_config']["twitch_channel"]
...
async def tspam(ctx, arg1, *, args):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/968925494236033074/jw8XuZXQbk31FwOIBF1DJzq6NLv871WXky2_Io5mVYY8uBdeUkZHVq9owsJZlrSvK52k')
    embed = DiscordEmbed(title='Twitch Follower V4', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}tspam -> {arg1} Message: {args}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel = json_object['bot_config']["twitch_channel"]
    genchannel2 = json_object['bot_config']["twitch_channel_2"] 
...
async def treport(ctx, arg):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/968925494236033074/jw8XuZXQbk31FwOIBF1DJzq6NLv871WXky2_Io5mVYY8uBdeUkZHVq9owsJZlrSvK52k')
    embed = DiscordEmbed(title='Twitch Follower V4', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}treport -> {arg}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel = json_object['bot_config']["twitch_channel"]
    genchannel2 = json_object['bot_config']["twitch_channel_2"]
...
async def tfriend(ctx, arg):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    embed = DiscordEmbed(title='Twitch Follower V4', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}tfriend -> {arg}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel = json_object['bot_config']["twitch_channel"]
    genchannel2 = json_object['bot_config']["twitch_channel_2"]
...
async def ttroll(ctx, arg1):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/958071838276190318/hyiJYup37H4UL6TJZI9-ohILVsYab2NdhDWhqFKz_n1GzIQ2L6nVsLsBqb-FxXes42kd')
    embed = DiscordEmbed(title='Twitch Follower V4', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}ttroll -> {arg1}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel = json_object['bot_config']["twitch_channel"]
    genchannel2 = json_object['bot_config']["twitch_channel_2"]  
...
async def traid(ctx, arg1):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/958071838276190318/hyiJYup37H4UL6TJZI9-ohILVsYab2NdhDWhqFKz_n1GzIQ2L6nVsLsBqb-FxXes42kd')
    embed = DiscordEmbed(title='Twitch Follower V4', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}traid -> {arg1}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel = json_object['bot_config']["twitch_channel"]
    genchannel2 = json_object['bot_config']["twitch_channel_2"]  
